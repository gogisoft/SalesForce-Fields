...
<ol>        
    ...
    <li class="sfFormCtrl">
    <asp:Label runat="server" AssociatedControlID="autoCompleteSource" CssClass="sfTxtLbl">Auto Complete Source</asp:Label>
    <asp:DropDownList ID="autoCompleteSource" runat="server" CssClass="sfTxt" />
    <div class="sfExample"></div>
    </li>
    
    <li class="sfFormCtrl">
    <asp:Label runat="server" AssociatedControlID="Note" CssClass="sfTxtLbl">Note</asp:Label>
    <asp:TextBox ID="Note" runat="server" CssClass="sfTxt" />
    <div class="sfExample"></div>
    </li>
