...
[assembly: WebResource(SalesForce.Fields.AutoCompleteDesigner.scriptReference, "application/x-javascript")]
namespace SalesForce.Fields
{
    /// <summary>
    /// Represents a designer for the <typeparamref name="SalesForce.Fields.AutoComplete"/> widget
    /// </summary>
    public class AutoCompleteDesigner : ControlDesignerBase
    {
        #region Properties
        /// <summary>
        ...
        public override string LayoutTemplatePath
        {
            get
            {
                if (string.IsNullOrEmpty(base.LayoutTemplatePath))
                    return AutoCompleteDesigner.layoutTemplatePath;
        ...
        protected virtual Control AutoCompleteSource
        {
            get
            {
                return this.Container.GetControl<Control>("autoCompleteSource", true);
            }
        }

        /// <summary>
        /// Gets the control that is bound to the Note property
        /// </summary>
        ...
        public override System.Collections.Generic.IEnumerable<System.Web.UI.ScriptDescriptor> GetScriptDescriptors()
        {
            ...
            descriptor.AddElementProperty("autoCompleteSource", this.AutoCompleteSource.ClientID);
        ...
        public override System.Collections.Generic.IEnumerable<System.Web.UI.ScriptReference> GetScriptReferences()
        {
            ...
            scripts.Add(new ScriptReference(AutoCompleteDesigner.scriptReference, typeof(AutoCompleteDesigner).Assembly.FullName));
            return scripts;
        }
        #endregion

        #region Private members & constants
        public static readonly string layoutTemplatePath = "~/SalesForce.Fields/Templates/AutoCompleteDesigner.ascx";
        public const string scriptReference = "SalesForce.Fields.Fields.SalesForce.AutoComplete.AutoCompleteDesigner.js";
        #endregion
    }
}
