...
[assembly: WebResource(SalesForce.Fields.TextFieldDesigner.scriptReference, "application/x-javascript")]
namespace SalesForce.Fields
{
    /// <summary>
using System;
    /// Represents a designer for the <typeparamref name="SalesForce.Fields.TextFieldDesigner"/> widget
    /// </summary>
    /// 
    public class TextFieldDesigner : ControlDesignerBase
    {
        ...
        public override string LayoutTemplatePath
        {
            get
            {
                if (string.IsNullOrEmpty(base.LayoutTemplatePath))
                    return TextFieldDesigner.layoutTemplatePath;
        ...
        public override System.Collections.Generic.IEnumerable<System.Web.UI.ScriptReference> GetScriptReferences()
        {
            ...
            scripts.Add(new ScriptReference(TextFieldDesigner.scriptReference, typeof(TextFieldDesigner).Assembly.FullName));
            return scripts;
        }
        #endregion

        #region Private members & constants
        public static readonly string layoutTemplatePath = "~/SalesForce.Fields/Templates/TextFieldDesigner.ascx";
        public const string scriptReference = "SalesForce.Fields.Fields.SalesForce.TextBox.TextFieldDesigner.js";
        #endregion
