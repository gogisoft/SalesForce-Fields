...
SalesForce.Fields.TextFieldDesigner = function (element) {
    ...
    SalesForce.Fields.TextBox.TextFieldDesigner.initializeBase(this, [element]);
}

SalesForce.Fields.TextFieldDesigner.prototype = {
    initialize: function () {
        /* Here you can attach to events or do other initialization */
        SalesForce.Fields.TextFieldDesigner.callBaseMethod(this, "initialize");
    },

    dispose: function () {
        /*  this is the place to unbind/dispose the event handlers created in the initialize method */
        SalesForce.Fields.TextFieldDesigner.callBaseMethod(this, "dispose");
    },
        /* --------------------------------- public methods ---------------------------------- */
...
SalesForce.Fields.TextFieldDesigner.registerClass("SalesForce.Fields.TextFieldDesigner", Telerik.Sitefinity.Web.UI.ControlDesign.ControlDesignerBase);
